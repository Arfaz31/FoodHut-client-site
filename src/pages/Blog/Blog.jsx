...
const Blog = () => {
    ...
    const generatePdf =  useReactToPrint({
        ...
        documentTitle: 'blogpage',
        onAfterPrint:()=> alert('Document print successfully')
    })
    return (
        <div className='mb-5'>
            <h1 className='bg-danger bg-opacity-11 text-white p-4 text-center'>Frequently Asked Questions</h1>
            <div className='lg-w-50 mx-auto mb-5 mt-5 text-center '>
             <button onClick={generatePdf} className='btn btn-danger lg-w-25 fw-bold py-2'><FaFilePdf/> Make it PDF</button> 
             </div>
            <div ref={blogPdf} className='w-75 mx-auto mt-2'>
